...
FT2M = 0.3048
CACHE = os.path.join(_SCRIPT_DIR, "yamamoto_2025_all.json")
...
if os.path.exists(CACHE):
    ...
    print("Fetching Yamamoto 2025 all pitches ...")
    df = statcast(start_dt="2025-03-20", end_dt="2025-10-01")
    df_d = df[df["pitcher"] == 808967].copy()
...
fig.suptitle("Yamamoto 2025 All Pitch Types — Location Distribution & 95% Ellipse",
...
out_path = os.path.join(_SCRIPT_DIR, "yamamoto_2025_all_pitches.png")
