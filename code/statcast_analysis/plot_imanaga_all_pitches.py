...
FT2M = 0.3048
CACHE = os.path.join(_SCRIPT_DIR, "imanaga_2025_all.json")
...
if os.path.exists(CACHE):
    ...
    print("Fetching Imanaga 2025 all pitches ...")
    df = statcast(start_dt="2025-03-20", end_dt="2025-10-01")
    df_d = df[df["pitcher"] == 684007].copy()
...
fig.suptitle("Imanaga 2025 All Pitch Types — Location Distribution & 95% Ellipse",
...
out_path = os.path.join(_SCRIPT_DIR, "imanaga_2025_all_pitches.png")
